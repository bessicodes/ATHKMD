    ...
    <section id="contact" className="relative grain py-20 sm:py-24 md:py-40">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <motion.a
          ...
          className="group relative mt-10 flex flex-col items-start justify-between gap-5 overflow-hidden border border-border p-5 transition-all duration-500 hover:border-foreground/40 hover:bg-card sm:mt-12 md:mt-16 md:flex-row md:items-center md:gap-6 md:p-12"
        >
