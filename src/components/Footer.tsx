...
export const Footer = () => (
  <footer className="relative border-t border-border py-16 grain">
    <div className="container mx-auto px-6 grid md:grid-cols-3 gap-10 items-center">
      <a href="#home" className="group justify-self-start">
        <p className="font-display text-xl tracking-widest transition-opacity group-hover:opacity-80">ATHLETE KINGDOM</p>
        <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">The Home of Sports</p>
      </a>
    ...
    <div className="container mx-auto px-6 mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between gap-4 text-xs uppercase tracking-[0.3em] text-muted-foreground">
